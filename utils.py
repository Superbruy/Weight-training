...
# @author    : cjr
# @date      : 2021-4-15
# @brief     : several auxiliary function
'''
import sys
import os
import numpy
...
def get_training_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    print("current data root:{}".format(Data_Dir))
    cifar10_training = torchvision.datasets.CIFAR10(root=Data_Dir, train=True, download=False,
...
def get_test_dataloader(mean, std, batch_size=16, num_workers=2, shuffle=True):
    ...
    cifar10_test = torchvision.datasets.CIFAR10(root=Data_Dir, train=False, download=False, transform=transform_test)
